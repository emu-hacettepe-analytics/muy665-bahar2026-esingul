...
#install.packages("ggtext", repos = "https://cran.rstudio.com/")
#install.packages("ggrepel", repos = "https://cran.rstudio.com/")
#install.packages("ggh4x", repos = "https://cran.rstudio.com/")
...
veri_kaynak_tablosu <- data.frame(Sıra = 1:5,
...
hanehalkı_tüketim <- read_xlsx("HaneTuketimii.xlsx")

nüfus <- read_xlsx("CinsiyeteGoreNufus.xlsx")
...
```{r eglencekultur-nufus-arasindaki-iliski, message=FALSE, warning=FALSE, echo=FALSE}
